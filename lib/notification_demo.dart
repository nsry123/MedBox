...
class _HomePageState extends State<HomePage> {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) => AlertDialog(
        content: Text('${pendingNotificationRequests.length} pending notification '
            'requests'),
        actionsOverflowButtonSpacing: 13.0,
        actions: <Widget>[
          TextButton(
            onPressed: () {
  ...
  Future<void> _repeatNotification() async {
    ...
    // flutterLocalNotificationsPlugin.zonedSchedule(id, title, body, scheduledDate, notificationDetails, uiLocalNotificationDateInterpretation: uiLocalNotificationDateInterpretation)
  }
